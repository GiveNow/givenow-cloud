...
//var twilioAuthToken = Parse.Config.get("twilioAuthToken");
//var twilioPhoneNumber = Parse.Config.get("twilioPhoneNumber");
//var secretPasswordToken = Parse.Config.get("secretPasswordToken");
...
//	if (!phoneNumber || (phoneNumber.length != 10 && phoneNumber.length != 11)) return res.error('Invalid Parameters');
    ...
    //			result.set("language", language);
                result.save().then(function() {
                    return sendCodeSms(phoneNumber,
                    num, body);
                }).then(function() {
